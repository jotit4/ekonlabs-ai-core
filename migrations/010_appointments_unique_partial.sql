-- F4: UNIQUE partial index to prevent double-booking.
-- Uses (tenant_id, service_id, start_at) since appointments reference services,
-- not calendar_id directly. ON CONFLICT DO NOTHING in booking service detects races.
